...
impl PeersAndMetadata {
    ...
    pub fn get_all_peers(&self) -> Result<Vec<PeerNetworkId>, Error> {
        ...
        let cached_peers_and_metadata = self.get_cached_peers_and_metadata();
    ...
    /// Returns a cached copy of the peers and metadata map
    fn get_cached_peers_and_metadata(&self) -> HashMap<NetworkId, HashMap<PeerId, PeerMetadata>> {

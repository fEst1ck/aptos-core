        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.signature.as_ref() {
            match v {
                ...
                account_signature::Signature::Secp256k1(v) => {
...
;
                        ...
                        GeneratedField::Secp256k1 => {
                            ...
                            signature__ = map.next_value::<::std::option::Option<_>>()?.map(account_signature::Signature::Secp256k1)
;
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "TYPE_SECP256K1" => Ok(account_signature::Type::Secp256k1),
...
impl serde::Serialize for Secp256k1Signature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("aptos.transaction.v1.Secp256k1Signature", len)?;
        if !self.public_key.is_empty() {
            struct_ser.serialize_field("publicKey", pbjson::private::base64::encode(&self.public_key).as_str())?;
        }
        if !self.signature.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Secp256k1Signature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct aptos.transaction.v1.Secp256k1Signature")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<Secp256k1Signature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut public_key__ = None;
        ...
        deserializer.deserialize_struct("aptos.transaction.v1.Secp256k1Signature", FIELDS, GeneratedVisitor)
    }
}
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.signature.as_ref() {
            match v {
                ...
                signature::Signature::Secp256k1(v) => {
                    struct_ser.serialize_field("secp256k1", v)?;
                }
            }
        }
...
;
                        ...
                        GeneratedField::Secp256k1 => {
                            ...
                            signature__ = map.next_value::<::std::option::Option<_>>()?.map(signature::Signature::Secp256k1)
;
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                match value {
                    ...
                    "TYPE_SECP256K1" => Ok(signature::Type::Secp256k1),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }

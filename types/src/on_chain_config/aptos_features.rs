...
pub enum FeatureFlag {
    ...
    DERIVABLE_ACCOUNT_ABSTRACTION = 97, //88,
    /// Whether function values are enabled.
    ENABLE_FUNCTION_VALUES = 98, //89,
    NEW_ACCOUNTS_DEFAULT_TO_FA_STORE = 99, //90,
    DEFAULT_ACCOUNT_RESOURCE = 100, //91,
    JWK_CONSENSUS_PER_KEY_MODE = 101, //92,
    TRANSACTION_PAYLOAD_V2 = 102, //93,
    ORDERLESS_TRANSACTIONS = 103, //94,
    // TODO(lazy-loading): Add link to AIP and its number + brief description.
    ENABLE_LAZY_LOADING = 104, //95,

    CALCULATE_TRANSACTION_FEE_FOR_DISTRIBUTION = 105, //96,
    DISTRIBUTE_TRANSACTION_FEE = 106, //97,
}

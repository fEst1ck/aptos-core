...
use crate::{
    ...
    value::BytesWithAggregatorLayout,
};
...
// types.
pub type AccountChangeSet = AccountChanges<Bytes, BytesWithAggregatorLayout>;
pub type ChangeSet = Changes<Bytes, BytesWithAggregatorLayout>;

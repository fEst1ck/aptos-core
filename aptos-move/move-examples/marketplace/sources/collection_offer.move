...
module collection_offer_tests {
    ...
    fun test_token_v2(
        ...
        let collection_offer = collection_offer::init_for_tokenv2<SupraCoin>(
            purchaser,
            collection,
        ...
        assert!(coin::balance<SupraCoin>(purchaser_addr) == 8999, 0);
        assert!(coin::balance<SupraCoin>(seller_addr) == 10000, 0);

        collection_offer::sell_tokenv2<SupraCoin>(seller, collection_offer, token);
        ...
        collection_offer::sell_tokenv2<SupraCoin>(purchaser, collection_offer, token);
        assert!(coin::balance<SupraCoin>(marketplace_addr) == 11, 0);
        assert!(coin::balance<SupraCoin>(purchaser_addr) == 9489, 0);
        assert!(coin::balance<SupraCoin>(seller_addr) == 10500, 0);
        assert!(object::is_owner(token, purchaser_addr), 0);
    ...
    fun test_token_v1_direct_deposit(
        ...
        let collection_offer = collection_offer::init_for_tokenv1<SupraCoin>(
            purchaser,
            creator_addr,
            collection_name,
            test_utils::fee_schedule(marketplace),
        ...
        collection_offer::sell_tokenv1<SupraCoin>(seller, collection_offer, token_name, property_version);
        assert!(coin::balance<SupraCoin>(marketplace_addr) == 6, 0);
        assert!(coin::balance<SupraCoin>(purchaser_addr) == 8999, 0);
        assert!(coin::balance<SupraCoin>(seller_addr) == 10495, 0);
        ...
        collection_offer::sell_tokenv1<SupraCoin>(purchaser, collection_offer, token_name, property_version);
        assert!(coin::balance<SupraCoin>(marketplace_addr) == 11, 0);
        assert!(coin::balance<SupraCoin>(purchaser_addr) == 9489, 0);
        assert!(coin::balance<SupraCoin>(seller_addr) == 10500, 0);
        assert!(tokenv1::balance_of(purchaser_addr, token_id) == 1, 0);
    ...
    fun test_token_v1_indirect(
        ...
        let token_container = collection_offer::sell_tokenv1<SupraCoin>(
            seller,
            collection_offer,
            token_name,
            property_version,
    ...
    #[test(supra_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x50004, location = supra_framework::object)]
    fun test_token_v2_has_none(
        ...
        collection_offer::sell_tokenv2<SupraCoin>(marketplace, collection_offer, token);
    }
    ...
    fun test_token_v1_has_none(
        ...
        collection_offer::sell_tokenv1<SupraCoin>(
            marketplace,
            collection_offer,
            token_name,
            property_version,

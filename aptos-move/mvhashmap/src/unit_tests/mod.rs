...
fn create_write_read_placeholder_struct() {
    ...
    // Write by txn 10.
    mvtbl.data().write(ap1.clone(), 10, 1, (value_for(10, 1), None));
    ...
    // More writes.
    mvtbl.data().write(ap1.clone(), 12, 0, (value_for(12, 0), None));
    mvtbl.data().write(ap1.clone(), 8, 3, (value_for(8, 3), None));
    ...
    mvtbl.data().write(ap2.clone(), 10, 2, (value_for(10, 2), None));
    ...
    mvtbl.data().write(ap2.clone(), 5, 0, (value_for(5, 0), None));
    mvtbl.data().write(ap3.clone(), 20, 4, (value_for(20, 4), None));

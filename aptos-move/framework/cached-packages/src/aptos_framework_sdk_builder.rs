...
// standard BCS-compatible representation used in Supra transactions (`Script`).
//
// This code was generated by compiling known Script interfaces ("ABIs") with the tool `supra-sdk-builder`.
...
impl EntryFunctionCall {
    /// Build an Supra `TransactionPayload` from a structured object `EntryFunctionCall`.
    pub fn encode(self) -> TransactionPayload {
    ...
    /// Try to recognize an Supra `TransactionPayload` and convert it into a structured object `EntryFunctionCall`.

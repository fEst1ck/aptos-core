module supra_framework::account {
    ...
    public fun create_account_if_does_not_exist(account_address: address) {
        if (!resource_exists_at(account_address)) {
            assert!(
                account_address != @vm_reserved && account_address != @supra_framework && account_address != @supra_token,
    ...
    public(friend) fun create_account(new_address: address): signer {
        ...
        assert!(
            new_address != @vm_reserved && new_address != @supra_framework && new_address != @supra_token,
            error::invalid_argument(ECANNOT_RESERVED_ADDRESS)
        );
    ...
    public fun originating_address(auth_key: address): Option<address> acquires OriginatingAddress {
        let address_map_ref = &OriginatingAddress[@supra_framework].address_map;
    ...
    entry fun set_originating_address(account: &signer) acquires Account, OriginatingAddress {
        ...
        let address_map_ref_mut =
            &mut OriginatingAddress[@supra_framework].address_map;
    ...
    fun update_auth_key_and_originating_address_table(
        ...
        let address_map = &mut OriginatingAddress[@supra_framework].address_map;
    ...
    public entry fun test_valid_rotate_authentication_key_multi_ed25519_to_multi_ed25519(
        ...
        let address_map = &OriginatingAddress[@supra_framework].address_map;

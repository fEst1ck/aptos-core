module supra_framework::account {
    ...
    use std::signer;
    use std::vector;
<<<<<<<< HEAD:aptos-move/framework/supra-framework/sources/account/account.move
...
>>>>>>>> aptos-framework-v1.34.0:aptos-move/framework/aptos-framework/sources/account/account.move

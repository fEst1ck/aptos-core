...
<<<<<<<< HEAD:aptos-move/framework/supra-framework/sources/account/account.spec.move
        aborts_if !exists<chain_id::ChainId>(@supra_framework);
========
        aborts_if !exists<chain_id::ChainId>(@aptos_framework);
>>>>>>>> aptos-framework-v1.34.0:aptos-move/framework/aptos-framework/sources/account/account.spec.move

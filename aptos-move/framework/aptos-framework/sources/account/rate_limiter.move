module supra_framework::rate_limiter {
    ...
    fun test_initialize_bucket(supra_framework: &signer) {
    ...
    #[test(supra_framework = @0x1)]
    fun test_request_success(supra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(supra_framework);
    ...
    #[test(supra_framework = @0x1)]
    fun test_request_failure(supra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(supra_framework);
        let bucket = initialize(10, 30);
    ...
    #[test(supra_framework = @0x1)]
    fun test_refill(supra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(supra_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(supra_framework= @0x1)]
    fun test_fractional_accumulation(supra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(supra_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(supra_framework= @0x1)]
    fun test_multiple_refills(supra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(supra_framework);
        let bucket = initialize(10, 60);

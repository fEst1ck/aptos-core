...
module supra_framework::supra_governance {
    ...
    public fun get_remaining_voting_power(
        ...
        let used_voting_power = *VotingRecordsV2[@supra_framework].votes.borrow_with_default(record_key, &0);
    ...
    fun vote_internal(
        ...
        let used_voting_power = VotingRecordsV2[@supra_framework].votes.borrow_mut_with_default(record_key, 0);
        ...
        *used_voting_power += voting_power;
        ...
        if (std::features::module_event_migration_enabled()) {
            ...
            let events = &mut GovernanceEvents[@supra_framework];
            event::emit_event(
    ...
    public entry fun test_voting_generic(
        ...
        setup_partial_voting(&supra_framework, &proposer, &yes_voter, &no_voter);
    ...
    #[expected_failure(abort_code = 65541, location = supra_framework::supra_governance)]
    ...
    #[test(supra_framework = @supra_framework, proposer = @0x123, voter_1 = @0x234, voter_2 = @345)]
    #[expected_failure(abort_code = 65551, location = supra_framework::supra_governance)]
    public entry fun test_cannot_vote_for_expired_proposal(
        ...
        setup_partial_voting_with_initialized_stake(&supra_framework, &proposer, &voter_1, &voter_2);
    ...
    #[test(supra_framework = @supra_framework, proposer = @0x123, voter_1 = @0x234, voter_2 = @0x345)]
    #[expected_failure(abort_code = 65539, location = supra_framework::supra_governance)]
    ...
    public fun setup_partial_voting_with_initialized_stake(
        ...
        setup_voting_with_initialized_stake(supra_framework, proposer, yes_voter, no_voter);
    }

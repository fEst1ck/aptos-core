spec supra_framework::supra_governance {
    ...
    spec assert_proposal_expiration(stake_pool: address, proposal_id: u64) {
        include VotingInitializationAbortIfs;
        include voting::AbortsIfNotContainProposalID<GovernanceProposal>{voting_forum_address: @supra_framework};
        let proposal_expiration = voting::spec_get_proposal_expiration_secs<GovernanceProposal>(@supra_framework, proposal_id);

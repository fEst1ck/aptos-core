spec supra_framework::vesting {
    ...
    /// period.
    /// Enforcement: Audited the check for the end of vesting cliff: [https://github.com/supra-labs/supra-core/blob/main/supra-move/framework/supra-framework/sources/vesting.move#L566](vest) module.
    ///
    /// No.: 5

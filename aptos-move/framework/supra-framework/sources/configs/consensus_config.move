...
<<<<<<< HEAD:aptos-move/framework/supra-framework/sources/configs/consensus_config.move
...
>>>>>>> aptos-framework-v1.34.0:aptos-move/framework/aptos-framework/sources/configs/consensus_config.move
            } else {

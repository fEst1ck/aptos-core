...
module supra_framework::resource_account {
    ...
    public entry fun without_coin(framework: signer, user: signer) acquires Container {
        let fa_features = vector[std::features::get_new_accounts_default_to_fa_store_feature(), std::features::get_new_accounts_default_to_fa_supra_store_feature(), std::features::get_operations_default_to_fa_supra_store_feature()];

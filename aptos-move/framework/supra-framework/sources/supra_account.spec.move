...
<<<<<<< HEAD:aptos-move/framework/supra-framework/sources/supra_account.spec.move
...
>>>>>>> aptos-framework-v1.34.0:aptos-move/framework/aptos-framework/sources/aptos_account.spec.move
    }

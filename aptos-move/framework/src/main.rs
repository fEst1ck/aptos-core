...
use supra_framework::{ReleaseOptions, ReleaseTarget};
use clap::Parser;

#[derive(Parser)]
#[clap(name = "supra-framework", author, version, propagate_version = true)]
enum Commands {
    /// Creates an Supra framework release for the specified target.

...
module aptos_std::bls12381 {
    ...
    fun test_verify_normal_and_verify_sigshare() {
        ...
        // `crates/aptos-crypto`
        // =============================================================================================================
        // SK:        06abd4a08ef4147f9859f89c86f39032b0c8b2087e3e19d7fbb6962e90cce2e0

        let message = b"Hello Supra!";

        // First, test signatures that verify
        let ok = verify_normal_signature(
            &signature_from_bytes(x"8f66c5259b880449e83ec27c2ef90f32778c550df0e98a815e8c7c0aab9478e45297917f6034a6bb456f2c8e14d01a33172f9847f903680a9a7ba889b8c0f4d0bbef15d7f7fe7a9a3d90fce38d1ce5932e3bbbb11e4eadc0903ef4982b047d8e"),
            &public_key_from_bytes(x"b8c6fd0e596ba70f4c7b6d2a6e4a6c95d921fb5abca6eb9c0c42737a681cb0e12263d851bc3e7a097e42432892b80445").extract(
            ),
            message,
        );
        assert!(ok == true, 1);

        let pk = public_key_from_bytes(x"8856a63c1d9679f0cfee94844923736d79d7ad3730429075cee2efe9476fe94248a72fad10dfa94e7e287456b803da0f").extract(
        );
        ...
        let sigs = vector[
            Signature { bytes: x"847f864459e45f8701fdd57aa5d2a26e572a2ea30e4a45b528ca4e909432f82f8c54f5004ad7a2f181db79ae4e3205c20798be362154fbdddf4d6e2ea849bb24302ca79cb437cbb8d3731799471b4c0b62672ca5b5ac425e19028950ac51992e" },
        ...
        let pks = vector[
            x"976d42ddd2f94795eed5258aabce893fdc9b1df0ffe70f3c900bb48adbfb98f8f68fcb1b170276adbd242f7a363b5063",
